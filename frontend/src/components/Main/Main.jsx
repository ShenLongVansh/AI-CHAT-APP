      ...
      <div className={styles.cards}>
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              AI CHAT APP is a Open AI powered chat bot based on
        ...
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              AI CHAT APP is a conversational AI chatbot designed to engage in
        ...
        <div className={styles.card}>
          ...
          <div className={styles.text}>
            ...
            <p>
              AI CHAT APP is also accompanied by a clean and responsive user
